...
import com.example.jdbctemplate.service.impl.StudentJdbcClientServiceImpl;
...
@RequestMapping("/student/jdbc-client")
public class StudentJdbcClientController {

    private final StudentJdbcClientServiceImpl studentService;
